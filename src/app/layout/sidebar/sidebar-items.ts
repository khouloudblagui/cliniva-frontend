...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      {
        path: '/admin/ingredient/all-ingredient',
      ...
      {
        path: '/admin/ingredient/add-ingredient',
      ...
      {
        path: '/admin/ingredient/upload-ingredient',
   ...
   // Ajout de l'élément "physical treatment" avec ses sous-éléments
{
...
},
  {
    ...
    submenu: [
      {
        path: 'admin/document-template/document-list',
...

  {
    ...
    submenu: [
      ...
      {
        path: '/admin/ICD10/ICD10-uploadExcel',
